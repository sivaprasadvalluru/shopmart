...
-- Seed products
INSERT IGNORE INTO products (id, name, short_description, description, price, image_url, category_id) VALUES
  (1,  'Wireless Noise-Cancelling Headphones',
       'Premium over-ear headphones, 30-hr battery.',
  ...
  (2,  'Smart Watch Series X',
       'Fitness tracking, notifications & contactless pay.',
  ...
  (3,  'Portable Bluetooth Speaker',
       'Waterproof 360° sound, 20-hour playtime.',
  ...
  (4,  '4K USB-C Monitor 27"',
       'Crystal-clear 4K display with USB-C power delivery.',
  ...
  (5,  'Classic Fit Cotton T-Shirt',
       '100% organic cotton, breathable everyday tee.',
  ...
  (6,  'Slim-Fit Chino Trousers',
       'Versatile stretch chinos for office or weekend.',
  ...
  (7,  'Lightweight Down Jacket',
       'Pack-away puffer — warm without the bulk.',
  ...
  (8,  'Running Sneakers Pro',
       'Responsive cushioning for long-distance runs.',
  ...
  (9,  'Stainless Steel Cookware Set (10 pc)',
       'Tri-ply construction, professional-grade pans.',
  ...
  (10, 'Programmable Coffee Maker',
       '12-cup maker with grinder & brew-strength control.',
  ...
  (11, 'Bamboo Cutting Board Set',
       'Eco-friendly set of 3 boards: S, M, and L.',
  ...
  (12, 'Robot Vacuum Cleaner',
       'Smart mapping, auto-empty, 180-min runtime.',
